...
import { Coins, Zap, Gift, Flame, TrendingDown, RefreshCw, ChevronRight } from "lucide-react";
    ...
    <section id="ecosystem" className="relative py-16 sm:py-24 overflow-hidden z-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              {ECOSYSTEM_MODULES.map((mod, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      {iconComponents[mod.icon] || <Coins className="w-4 h-4 sm:w-5 sm:h-5 text-[#F0C75E]" />}
                    </div>
          ...
          {/* Right: Module Detail Card & Mobile Selector Tabs */}
          <div className="lg:col-span-5 flex flex-col justify-center">
            
            {/* Mobile Module Selector Horizontal Scroll Bar */}
